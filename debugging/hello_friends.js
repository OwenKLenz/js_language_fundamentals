...
// The invocation of `randomGreeting` is missing `()` so `greeting` will reference the value of the function object referenced by `randomGreeting`.
// The randomGreeting function is also missing a `return` statement.
