...
// Because of the order of operations of logical operators, if the first half of an && statement evaluates to false, the expression will short circuit and the second half will never evaluate. As a result, if the museum includes neither 'Computer' or 'Science', the second half will never evaluate and false will always be returned.
